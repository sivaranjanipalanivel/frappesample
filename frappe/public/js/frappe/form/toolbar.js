...
frappe.ui.form.Toolbar = Class.extend({
	...
	refresh: function() {
		...
		if(this.frm.meta.hide_toolbar) {
			this.page.hide_menu();
			this.page.hide_translation_menu();
		} else {
			if(this.frm.doc.__islocal) {
				...
				this.page.show_menu();
				console.log("----tool")
				console.log(frappe.boot.sysdefaults.translation_settings)
				if(frappe.boot.sysdefaults.translation_settings.enable_doctype_translation==1){
					this.page.show_translation_menu()
				}
				else{
					this.page.hide_translation_menu();
				}
