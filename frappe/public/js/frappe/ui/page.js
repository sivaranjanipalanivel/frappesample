...
frappe.ui.Page = Class.extend({
	...
	setup_page: function() {
		...
		//translation
		this.translation = this.page_actions.find(".add-translation");
		this.menu_translation_btn = this.page_actions.find(".add-translation");
	...
	clear_translation_menu: function() {
		this.clear_btn_group(this.menu_translation_btn);
	},

	show_translation_menu: function() {
		this.menu_translation_btn.removeClass("hide");
	},

	hide_translation_menu: function() {
		this.menu_translation_btn.addClass("hide");
	},
...
// 	var field_option=[];
// 	frappe.call({
// 		method: 'ecommerce_business_store.ecommerce_business_store.api.get_fields_label_with_options',
...
// 		primary_action:
// 			(values) => this.update_translations(this.dialog.get_values())
// 				.then(() => {
// 					this.dialog.hide();
...
// 	// return frappe.db.get_list('Custom Doc Translation', {
// 	// 	fields: ['*'],
// 	// 	filters: {
// 	// 		name: strip_html(source_name)
// 	// 	}
// 	// });
// 	return frappe.db.get_list('DocType Translation', {
// 		fields: ['idx','field_translate','source_name','language','target_name','name'],
// 		filters: {
// 			parent: source_value,
// 		}
// 	});
...
// 	console.log(data.source_value)
// 	console.log(data.translation_data)
// 	return frappe.call({
// 		method: 'ecommerce_business_store.ecommerce_business_store.api.update_translations_for_docpage',
