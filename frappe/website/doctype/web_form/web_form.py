...
""")
	...
	def get_context(self, context):
		...
		if frappe.form_dict.new:
			context.current_webform_name=self.title

		context.show_sidebar=self.show_sidebar
	...
	def load_document(self, context):
		...
		if frappe.form_dict.name:
			...
			context.current_webform_name=context.doc.get(context.doc.meta.get_title_field())
