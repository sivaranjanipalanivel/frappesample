...
def get_context(path, args=None):
	...
	context.CatalogSettings=frappe.get_single('Catalog Settings')
	
	context.MediaSettings=frappe.get_single('Media Settings')
	context.CartSettings=frappe.get_single('Shopping Cart Settings')
	context.OrderSettings=frappe.get_single('Order Settings')
	return context
